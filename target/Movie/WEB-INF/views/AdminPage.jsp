            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="inputadminname" class="col-sm-2 control-label">AdminName</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="adminName" id="inputAdminName" placeholder="AdminName">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputAdminPassWord" class="col-sm-2 control-label">Password Field</label>
                        <div class="col-sm-10">
                            <input type="password" class="form-control" name="passWord" id="inputAdminPassWord" placeholder="Password">
                        </div>
                    </div>
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel2">Update Admin</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="updateAdminname" class="col-sm-2 control-label">AdminName</label>
                        <div class="col-sm-10">
                            <p class="form-control-static" id="updateAdminname"></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="updateAdminPassWord" class="col-sm-2 control-label">Password Field</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="passWord" id="updateAdminPassWord" placeholder="Password">
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="content-box-large">
                        <div class="panel-heading">
                            <div class="panel-title"><h2>Admin Info</h2></div>
...
//            添加一个自定义属性
            editBtn.attr("edit_id",item.adminName);
...
//        alert("edit");
    ...
    function getAdmin(adminName){
        $.ajax({
            url:"${ProPath}/Admin/"+adminName,
            type:"GET",
            success:function(result){
                    var admin = result.extend.admin;
                    $("#updateAdminname").text(admin.adminName);
                    $("#updateAdminPassWord").val(admin.passWord);
...
//  点击更新按钮
    $("#updateSubmit").click(function(){
        $.ajax({
            url:"${ProPath}/Admin/"+$(this).attr("edit_id"),
            type:"PUT",
