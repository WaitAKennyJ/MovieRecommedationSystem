...
<%@ page import="com.wzj.model.Movie" %>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="inputPublishYear" class="col-sm-2 control-label">publishYear</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="publishYear" id="inputPublishYear" placeholder="publishYear">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputGenres" class="col-sm-2 control-label">Genres</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="genres" id="inputGenres" placeholder="Genres">
                        </div>
                    </div>
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel2">Update Movie</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="title" id="updateTitle" placeholder="Title">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="updatePublishYear" class="col-sm-2 control-label">publishYear</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="publishYear" id="updatePublishYear" placeholder="publishYear">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="updateGenres" class="col-sm-2 control-label">Genres</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="genres" id="updateGenres" placeholder="Genres">
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="content-box-large">
                        <div class="panel-heading">
                            <div class="panel-title"><h2>Movie Info</h2></div>
                            ...
                            <div class="col-md-12">
                                <table class="table table-hover" id="Table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="col-md-2">PublishYear</th>
...
//            添加一个自定义属性
            editBtn.attr("edit_id",item.movieID);
...
//        alert($(this).attr("edit_id"));
    ...
    function getAdmin(adminName){
        $.ajax({
            url:"${ProPath}/Movie/"+adminName,
            type:"GET",
            success:function(result){
                var admin = result.extend.movie;
                $("#updateTitle").val(admin.title);
                $("#updatePublishYear").val(admin.publishYear);
                $("#updateGenres").val(admin.genres);
    ...
    $("#updateSubmit").click(function(){
        $.ajax({
            url:"${ProPath}/Movie/"+$(this).attr("edit_id"),
            type:"PUT",
